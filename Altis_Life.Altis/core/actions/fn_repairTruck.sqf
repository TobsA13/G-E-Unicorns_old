...
if((_veh getHitPointDamage "HitEngine" > 0.80) || (_veh getHitPointDamage "HitFuel" > 0.80) || (_veh getHitPointDamage "HitBody" > 0.80) || getMarkerPos "adac_car_1" distance player > 20) exitWith {titleText["Das Fahrzeug ist zu start zerstört um es hier zu Reparieren. Du musst in eine Werkstatt!","PLAIN"]; _killit = true;};
