...
*/
private["_index","_veh","_color","_price","_sp","_kill","_dir","_name","_sv","_fed","_double","_unit"];
_kill = false;
_double = false;
//_unit = player;
...
switch(life_veh_shop) do
{
    ...
    case "med_air_1":
	{
		_sp = [3731.3271, 12976.697, 19.350763];
		_dir = -1.0222231;
	};
    case "med_car_1":
	{
		_sp = getMarkerPos "med_car_1";
		_dir = markerDir "med_car_1";
	};
    case "adac_air_1":
	{
		_sp = getMarkerPos "adac_air_1";
		_dir = markerDir "adac_air_1";
	};
    case "adac_car_1":
	{
